...
export function WalletAnalysisCard({ walletData }: WalletAnalysisCardProps) {
  ...
  const getActivityTrend = () => {
    ...
    return {
      icon: <Activity className="h-3 w-3 sm:h-4 sm:w-4 text-gray-500" />,
      text: "Stable",
      color: "text-gray-600",
    }
  }
        ...
        <CardHeader className="pb-3 sm:pb-4">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="min-w-0 flex-1">
              <CardTitle className="text-lg sm:text-2xl bg-gradient-to-r from-purple-600 to-cyan-600 bg-clip-text text-transparent">
                Wallet Analysis
              </CardTitle>
