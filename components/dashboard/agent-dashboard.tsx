...
import { Plus, Bot, Brain, PenLine, PlayCircle, Database, Info } from "lucide-react"
  ...
  return (
    <div className="min-h-screen  p-6">
      <div className="space-y-8">
        <SidebarTrigger className="absolute bg-gray-800 hover:bg-gray-700 text-white border-gray-600 top-4 left-4 z-10" />

        {/* Header */}
        <div className="flex items-center justify-between">
          <div>
            <h1 className={`text-xl text-white ${pressStart2P.className}`}>MindCP Neural Dashboard</h1>
            <p className="text-gray-400 mt-1">Manage your AI agents and neural networks</p>
          </div>
          <CustomWalletButton />
        </div>
        ...
        <div>
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-white">Getting Started with Your AI Agents</h2>
