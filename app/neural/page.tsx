...
export default function NeuralNetworksComingSoon() {
  return (
    <section className="relative flex h-screen w-full items-center justify-center overflow-hidden py-24 bg-black">
      ...
      >
        ...
        <h1 className="text-3xl font-extrabold text-white">Neural&nbsp;Networks</h1>
        <p className="mx-auto max-w-md text-lg text-gray-300">
          This section is under construction. We're training something incredible – check back soon to explore neural
          model dashboards, telemetry&nbsp;and more.
        </p>

        <div className="flex justify-center">
          <Link href="https://t.me/MindCPAI" target="_blank">
            <NeonButton title=" Notify&nbsp;Me"></NeonButton>
          </Link>
        </div>
      </div>
    </section>
